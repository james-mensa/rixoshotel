...
const navigate=useNavigate()
    ...
    return(
        ...
        <p className="row-styles"><Filter/> <span>Filter</span> </p>
      ...
      <div className="row-styles">
        ...
        <div className="row-styles" >
            <input className="input-box" type="number" name="search" placeholder="room number" min="1"/>
        ...
        onClick={()=>{
         ...
         className="searchbtn">Add new Room</span>
