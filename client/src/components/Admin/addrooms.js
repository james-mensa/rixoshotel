...
const AddRoom = () => {
  ...
  const Formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      room_numer: Yup.number().required("field required"),
...
<div className="column-styles-l" style={{ marginTop: "15px", marginBottom:"20px" }}>
          <p>
            <span style={{ color: "red" }}>*</span> Room number
          </p>
          <TextField
            name="room_numer"
            style={{
            ...
            type="number"
            className="textbox"
            value={Formik.values.room_numer}
            onChange={Formik.handleChange}
            onBlur={Formik.handleBlur}
            error={
              Formik.touched.room_numer && Boolean(Formik.errors.room_numer)
            }
          ></TextField>
        </div>
